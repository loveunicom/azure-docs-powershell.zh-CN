...
<span data-ttu-id="a81ec-120">回答“是”或“全部确认”，可继续进行安装。</span><span class="sxs-lookup"><span data-stu-id="a81ec-120">Answer 'Yes' or 'Yes to All' to continue with the installation.</span></span>
