...
#### <a name="azurermiothub"></a><span data-ttu-id="11fd3-114">AzureRM.IotHub</span><span class="sxs-lookup"><span data-stu-id="11fd3-114">AzureRM.IotHub</span></span>
...
#### <a name="azurermwebsites"></a><span data-ttu-id="11fd3-132">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="11fd3-132">AzureRM.Websites</span></span>
...
#### <a name="azurermapplicationinsights"></a><span data-ttu-id="11fd3-149">AzureRM.ApplicationInsights</span><span class="sxs-lookup"><span data-stu-id="11fd3-149">AzureRM.ApplicationInsights</span></span>
...
#### <a name="azurermconsumption"></a><span data-ttu-id="11fd3-169">AzureRM.Consumption</span><span class="sxs-lookup"><span data-stu-id="11fd3-169">AzureRM.Consumption</span></span>
...
#### <a name="azurermdevtestlabs"></a><span data-ttu-id="11fd3-186">AzureRM.DevTestLabs</span><span class="sxs-lookup"><span data-stu-id="11fd3-186">AzureRM.DevTestLabs</span></span>
...
#### <a name="azurermmachinelearning"></a><span data-ttu-id="11fd3-204">AzureRM.MachineLearning</span><span class="sxs-lookup"><span data-stu-id="11fd3-204">AzureRM.MachineLearning</span></span>
...
#### <a name="azurermnotificationhubs"></a><span data-ttu-id="11fd3-221">AzureRM.NotificationHubs</span><span class="sxs-lookup"><span data-stu-id="11fd3-221">AzureRM.NotificationHubs</span></span>
...
#### <a name="azurermrecoveryservicessiterecovery"></a><span data-ttu-id="11fd3-239">AzureRM.RecoveryServices.SiteRecovery</span><span class="sxs-lookup"><span data-stu-id="11fd3-239">AzureRM.RecoveryServices.SiteRecovery</span></span>
...
#### <a name="azurermservicebus"></a><span data-ttu-id="11fd3-260">AzureRM.ServiceBus</span><span class="sxs-lookup"><span data-stu-id="11fd3-260">AzureRM.ServiceBus</span></span>
...
#### <a name="azurermwebsites"></a><span data-ttu-id="11fd3-276">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="11fd3-276">AzureRM.Websites</span></span>
...
#### <a name="azurermcompute"></a><span data-ttu-id="11fd3-294">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="11fd3-294">AzureRM.Compute</span></span>
...
#### <a name="azurermeventhub"></a><span data-ttu-id="11fd3-312">AzureRM.EventHub</span><span class="sxs-lookup"><span data-stu-id="11fd3-312">AzureRM.EventHub</span></span>
...
#### <a name="azurermsql"></a><span data-ttu-id="11fd3-327">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="11fd3-327">AzureRM.Sql</span></span>
...
## <a name="650---july-2018"></a><span data-ttu-id="11fd3-344">6.5.0 - 2018 年 7 月</span><span class="sxs-lookup"><span data-stu-id="11fd3-344">6.5.0 - July 2018</span></span>
...
#### <a name="azurermeventhub"></a><span data-ttu-id="11fd3-361">AzureRM.EventHub</span><span class="sxs-lookup"><span data-stu-id="11fd3-361">AzureRM.EventHub</span></span>
...
#### <a name="azurermresources"></a><span data-ttu-id="11fd3-376">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="11fd3-376">AzureRM.Resources</span></span>
...
#### <a name="azurermwebsites"></a><span data-ttu-id="11fd3-397">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="11fd3-397">AzureRM.Websites</span></span>
...
#### <a name="azurermdatalakeanalytics"></a><span data-ttu-id="11fd3-414">AzureRM.DataLakeAnalytics</span><span class="sxs-lookup"><span data-stu-id="11fd3-414">AzureRM.DataLakeAnalytics</span></span>
...
#### <a name="azurermnetwork"></a><span data-ttu-id="11fd3-431">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="11fd3-431">AzureRM.Network</span></span>
...
* <span data-ttu-id="11fd3-451">更新了 Get/New/Remove/Set-AzureRmPolicyDefinition cmdlet</span><span class="sxs-lookup"><span data-stu-id="11fd3-451">Update Get/New/Remove/Set-AzureRmPolicyDefinition cmdlets</span></span>
    ...
    - <span data-ttu-id="11fd3-453">添加了 -SubscriptionId 参数，以将操作应用到给定的订阅</span><span class="sxs-lookup"><span data-stu-id="11fd3-453">Add -SubscriptionId parameter to apply operations to a given subscription</span></span>
...
#### <a name="azurestorage"></a><span data-ttu-id="11fd3-469">Azure.存储</span><span class="sxs-lookup"><span data-stu-id="11fd3-469">Azure.Storage</span></span>
...
* <span data-ttu-id="11fd3-477">修复了以下 cmdlet，因此可以正确地显示“操作 ID”和“操作状态”：</span><span class="sxs-lookup"><span data-stu-id="11fd3-477">Fixed following cmdlets to show 'operation ID' and 'operation status' correctly:</span></span>
    ...
    - <span data-ttu-id="11fd3-485">Stop-AzureRmVmssRollingUpgrade</span><span class="sxs-lookup"><span data-stu-id="11fd3-485">Stop-AzureRmVmssRollingUpgrade</span></span>
    - <span data-ttu-id="11fd3-486">Start-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="11fd3-486">Start-AzureRmVmss</span></span>
    - <span data-ttu-id="11fd3-487">Restart-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="11fd3-487">Restart-AzureRmVmss</span></span>
    - <span data-ttu-id="11fd3-488">Stop-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="11fd3-488">Stop-AzureRmVmss</span></span>
    - <span data-ttu-id="11fd3-489">Remove-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="11fd3-489">Remove-AzureRmVmss</span></span>
    - <span data-ttu-id="11fd3-490">ConvertTo-AzureRmVMManagedDisk</span><span class="sxs-lookup"><span data-stu-id="11fd3-490">ConvertTo-AzureRmVMManagedDisk</span></span>
    - <span data-ttu-id="11fd3-491">Revoke-AzureRmSnapshotAccess</span><span class="sxs-lookup"><span data-stu-id="11fd3-491">Revoke-AzureRmSnapshotAccess</span></span>
    - <span data-ttu-id="11fd3-492">Remove-AzureRmSnapshot</span><span class="sxs-lookup"><span data-stu-id="11fd3-492">Remove-AzureRmSnapshot</span></span>
    - <span data-ttu-id="11fd3-493">Revoke-AzureRmDiskAccess</span><span class="sxs-lookup"><span data-stu-id="11fd3-493">Revoke-AzureRmDiskAccess</span></span>
    - <span data-ttu-id="11fd3-494">Remove-AzureRmDisk</span><span class="sxs-lookup"><span data-stu-id="11fd3-494">Remove-AzureRmDisk</span></span>
    - <span data-ttu-id="11fd3-495">Remove-AzureRmContainerService</span><span class="sxs-lookup"><span data-stu-id="11fd3-495">Remove-AzureRmContainerService</span></span>
    - <span data-ttu-id="11fd3-496">Remove-AzureRmAvailabilitySet</span><span class="sxs-lookup"><span data-stu-id="11fd3-496">Remove-AzureRmAvailabilitySet</span></span>

#### <a name="azurermeventgrid"></a><span data-ttu-id="11fd3-497">AzureRM.EventGrid</span><span class="sxs-lookup"><span data-stu-id="11fd3-497">AzureRM.EventGrid</span></span>
* <span data-ttu-id="11fd3-498">在 Update-AzureRmEventGridSubscription cmdlet 中删除 SubjectBeginsWith/SubjectEndsWith 的 ValidateNotNullOrEmpty 验证条件，允许根据需要将这些参数更改为空字符串。</span><span class="sxs-lookup"><span data-stu-id="11fd3-498">Remove ValidateNotNullOrEmpty validation conditions for SubjectBeginsWith/SubjectEndsWith in Update-AzureRmEventGridSubscription cmdlet to allow changing these parameters to empty string if needed.</span></span>

#### <a name="azurermkeyvault"></a><span data-ttu-id="11fd3-499">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="11fd3-499">AzureRM.KeyVault</span></span>
* <span data-ttu-id="11fd3-500">修复运行 Get-AzureRmKeyVault -Tag 时不返回任何标记的问题</span><span class="sxs-lookup"><span data-stu-id="11fd3-500">Fix issue where no Tags are being returned when Get-AzureRmKeyVault -Tag is run</span></span>

#### <a name="azurermpolicyinsights"></a><span data-ttu-id="11fd3-501">AzureRM.PolicyInsights</span><span class="sxs-lookup"><span data-stu-id="11fd3-501">AzureRM.PolicyInsights</span></span>
* <span data-ttu-id="11fd3-502">策略见解 cmdlet 的公开发行版</span><span class="sxs-lookup"><span data-stu-id="11fd3-502">Public release of Policy Insights cmdlets</span></span>
    - <span data-ttu-id="11fd3-503">使用 API 版本 2018-04-04</span><span class="sxs-lookup"><span data-stu-id="11fd3-503">Use API version 2018-04-04</span></span>
    - <span data-ttu-id="11fd3-504">向 Get-AzureRmPolicyStateSummary 的结果添加了 PolicyDefinitionReferenceId</span><span class="sxs-lookup"><span data-stu-id="11fd3-504">Add PolicyDefinitionReferenceId to the results of Get-AzureRmPolicyStateSummary</span></span>

#### <a name="azurermrecoveryservicesbackup"></a><span data-ttu-id="11fd3-505">AzureRM.RecoveryServices.Backup</span><span class="sxs-lookup"><span data-stu-id="11fd3-505">AzureRM.RecoveryServices.Backup</span></span>
* <span data-ttu-id="11fd3-506">向 RecoveryServices.Backup cmdlet 添加了 -Vault 参数。</span><span class="sxs-lookup"><span data-stu-id="11fd3-506">Added -Vault parameter to RecoveryServices.Backup cmdlets.</span></span> <span data-ttu-id="11fd3-507">传递时，此项会替代 Set-AzureRmRecoveryServicesContext cmdlet。</span><span class="sxs-lookup"><span data-stu-id="11fd3-507">When passed, this will override the Set-AzureRmRecoveryServicesContext cmdlet.</span></span>

#### <a name="azurermsql"></a><span data-ttu-id="11fd3-508">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="11fd3-508">AzureRM.Sql</span></span>
* <span data-ttu-id="11fd3-509">更新了 Get-AzureRmSqlDatabaseExpanded 的帮助文件中的示例</span><span class="sxs-lookup"><span data-stu-id="11fd3-509">Updated example in the help file for Get-AzureRmSqlDatabaseExpanded</span></span>

#### <a name="azurermtrafficmanager"></a><span data-ttu-id="11fd3-510">AzureRM.TrafficManager</span><span class="sxs-lookup"><span data-stu-id="11fd3-510">AzureRM.TrafficManager</span></span>
* <span data-ttu-id="11fd3-511">更新了 Add-AzureRmTrafficManagerEndpointConfig 的帮助文件</span><span class="sxs-lookup"><span data-stu-id="11fd3-511">Updated the help file for Add-AzureRmTrafficManagerEndpointConfig</span></span>

#### <a name="azurermwebsites"></a><span data-ttu-id="11fd3-512">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="11fd3-512">AzureRM.Websites</span></span>
* <span data-ttu-id="11fd3-513">更新了“Set-AzureRmWebApp”，在使用 -AssignIdentity 时不覆盖 AppSettings</span><span class="sxs-lookup"><span data-stu-id="11fd3-513">'Set-AzureRmWebApp' is updated to not overwrite the AppSettings when using -AssignIdentity</span></span>
* <span data-ttu-id="11fd3-514">更新了“New-AzureRmWebAppSlot”，允许使用 AppServicePlan 作为可选参数</span><span class="sxs-lookup"><span data-stu-id="11fd3-514">'New-AzureRmWebAppSlot' is updated to honor AppServicePlan as an optional parameter</span></span>

## <a name="621---june-2018"></a><span data-ttu-id="11fd3-515">6.2.1 - 2018 年 6 月</span><span class="sxs-lookup"><span data-stu-id="11fd3-515">6.2.1 - June 2018</span></span>
### <a name="azurermoperationalinsights"></a><span data-ttu-id="11fd3-516">AzureRM.OperationalInsights</span><span class="sxs-lookup"><span data-stu-id="11fd3-516">AzureRM.OperationalInsights</span></span>
* <span data-ttu-id="11fd3-517">更新了 PSWorkspace 模型，允许 Network 使用 type 作为参数</span><span class="sxs-lookup"><span data-stu-id="11fd3-517">Updated PSWorkspace model to allow Network to use type as a parameter</span></span>

## <a name="620---june-2018"></a><span data-ttu-id="11fd3-518">6.2.0 - 2018 年 6 月</span><span class="sxs-lookup"><span data-stu-id="11fd3-518">6.2.0 - June 2018</span></span>
#### <a name="azurermprofile"></a><span data-ttu-id="11fd3-519">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="11fd3-519">AzureRM.Profile</span></span>
* <span data-ttu-id="11fd3-520">修复了 Newtonsoft.Json 的版本 10.0.3 在模块导入时无法加载的问题</span><span class="sxs-lookup"><span data-stu-id="11fd3-520">Fix issue where version 10.0.3 of Newtonsoft.Json wasn't being loaded on module import</span></span>

#### <a name="azurermcompute"></a><span data-ttu-id="11fd3-521">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="11fd3-521">AzureRM.Compute</span></span>
* <span data-ttu-id="11fd3-522">VMSS VM 更新功能</span><span class="sxs-lookup"><span data-stu-id="11fd3-522">VMSS VM Update feature</span></span>
    - <span data-ttu-id="11fd3-523">增加了“Update-AzureRmVmssVM”和“New-AzureRmVMDataDisk”cmdlet</span><span class="sxs-lookup"><span data-stu-id="11fd3-523">Added 'Update-AzureRmVmssVM' and 'New-AzureRmVMDataDisk' cmdlets</span></span>
    - <span data-ttu-id="11fd3-524">为“Add-AzureRmVMDataDisk”cmdlet 增加了 VirtualMachineScaleSetVM 参数，支持向 Vmss VM 添加数据磁盘。</span><span class="sxs-lookup"><span data-stu-id="11fd3-524">Add VirtualMachineScaleSetVM parameter to 'Add-AzureRmVMDataDisk' cmdlet to support adding a data disk to Vmss VM.</span></span>

#### <a name="azurermdatafactoryv2"></a><span data-ttu-id="11fd3-525">AzureRM.DataFactoryV2</span><span class="sxs-lookup"><span data-stu-id="11fd3-525">AzureRM.DataFactoryV2</span></span>
* <span data-ttu-id="11fd3-526">将 ADF.Net SDK 版本更新到了 0.8.0-preview，其中包含以下更改：</span><span class="sxs-lookup"><span data-stu-id="11fd3-526">Updated the ADF .Net SDK version to 0.8.0-preview containing following changes:</span></span>
    - <span data-ttu-id="11fd3-527">增加了“配置工厂存储库”操作</span><span class="sxs-lookup"><span data-stu-id="11fd3-527">Added Configure factory repository operation</span></span>
    - <span data-ttu-id="11fd3-528">更新了 QuickBooks LinkedService，可以公开 consumerKey 和 consumerSecret 属性</span><span class="sxs-lookup"><span data-stu-id="11fd3-528">Updated QuickBooks LinkedService to expose consumerKey and consumerSecret properties</span></span>
    - <span data-ttu-id="11fd3-529">已将多个模型类型从 SecretBase 更新为 Object</span><span class="sxs-lookup"><span data-stu-id="11fd3-529">Updated Several model types from SecretBase to Object</span></span>
    - <span data-ttu-id="11fd3-530">增加了 Blob 事件触发器</span><span class="sxs-lookup"><span data-stu-id="11fd3-530">Added Blob Events trigger</span></span>

### <a name="azurermkeyvault"></a><span data-ttu-id="11fd3-531">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="11fd3-531">AzureRM.KeyVault</span></span>
* <span data-ttu-id="11fd3-532">使用示例输出更新了文档</span><span class="sxs-lookup"><span data-stu-id="11fd3-532">Update documentation with example output</span></span>

### <a name="azurermnetwork"></a><span data-ttu-id="11fd3-533">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="11fd3-533">AzureRM.Network</span></span>
* <span data-ttu-id="11fd3-534">在网络观察程序 cmdlet 上启用了流量分析参数</span><span class="sxs-lookup"><span data-stu-id="11fd3-534">Enable Traffic Analytics parameters on Network Watcher cmdlets</span></span>

#### <a name="azurermresources"></a><span data-ttu-id="11fd3-535">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="11fd3-535">AzureRM.Resources</span></span>
* <span data-ttu-id="11fd3-536">修复了从“Get-AzureRmResource”返回的“PSResource”对象的“Properties”属性问题</span><span class="sxs-lookup"><span data-stu-id="11fd3-536">Fix issue with 'Properties' property of 'PSResource' object(s) returned from 'Get-AzureRmResource'</span></span>

#### <a name="azurermscheduler"></a><span data-ttu-id="11fd3-537">AzureRM.Scheduler</span><span class="sxs-lookup"><span data-stu-id="11fd3-537">AzureRM.Scheduler</span></span>
* <span data-ttu-id="11fd3-538">修复了更新 ServiceBusQueueJob 无法设置新 Auth 值的问题</span><span class="sxs-lookup"><span data-stu-id="11fd3-538">Fix issue with update ServiceBusQueueJob not setting new Auth values</span></span>

### <a name="azurermsql"></a><span data-ttu-id="11fd3-539">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="11fd3-539">AzureRM.Sql</span></span>
* <span data-ttu-id="11fd3-540">使用可选的 LicenseType 参数更新了以下 cmdlet</span><span class="sxs-lookup"><span data-stu-id="11fd3-540">Updated the following cmdlets with optional LicenseType parameter</span></span>
    - <span data-ttu-id="11fd3-541">New-AzureRmSqlDatabase；Set-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="11fd3-541">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span></span>
    - <span data-ttu-id="11fd3-542">New-AzureRmSqlElasticPool；Set-AzureRmSqlElasticPool</span><span class="sxs-lookup"><span data-stu-id="11fd3-542">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span></span>
    - <span data-ttu-id="11fd3-543">New-AzureRmSqlDatabaseCopy</span><span class="sxs-lookup"><span data-stu-id="11fd3-543">New-AzureRmSqlDatabaseCopy</span></span>
    - <span data-ttu-id="11fd3-544">New-AzureRmSqlDatabaseSecondary</span><span class="sxs-lookup"><span data-stu-id="11fd3-544">New-AzureRmSqlDatabaseSecondary</span></span>
    - <span data-ttu-id="11fd3-545">Restore-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="11fd3-545">Restore-AzureRmSqlDatabase</span></span>

#### <a name="azurermwebsites"></a><span data-ttu-id="11fd3-546">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="11fd3-546">AzureRM.Websites</span></span>
* <span data-ttu-id="11fd3-547">更新了“New-AzureRMWebApp”，可以使用策略库中的常用算法。</span><span class="sxs-lookup"><span data-stu-id="11fd3-547">'New-AzureRMWebApp' is updated to use common algorithms from the Strategy library.</span></span>

## <a name="610---may-2018"></a><span data-ttu-id="11fd3-548">6.1.0 - 2018 年 5 月</span><span class="sxs-lookup"><span data-stu-id="11fd3-548">6.1.0 - May 2018</span></span>
#### <a name="azurermprofile"></a><span data-ttu-id="11fd3-549">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="11fd3-549">AzureRM.Profile</span></span>
* <span data-ttu-id="11fd3-550">修复了运行“Clear-AzureRmContext”时会保留空上下文的问题，该上下文使用旧的默认上下文的名称，导致用户无法使用旧名称创建新的上下文</span><span class="sxs-lookup"><span data-stu-id="11fd3-550">Fix issue where running 'Clear-AzureRmContext' would keep an empty context with the name of the previous default context, which prevented the user from creating a new context with the old name</span></span>

#### <a name="azurermanalysisservices"></a><span data-ttu-id="11fd3-551">AzureRM.AnalysisServices</span><span class="sxs-lookup"><span data-stu-id="11fd3-551">AzureRM.AnalysisServices</span></span>
* <span data-ttu-id="11fd3-552">允许在 AS 上执行网关的关联/取消关联操作。</span><span class="sxs-lookup"><span data-stu-id="11fd3-552">Enable Gateway assocaite/disassociate operations on AS.</span></span>

#### <a name="azurermapimanagement"></a><span data-ttu-id="11fd3-553">AzureRM.ApiManagement</span><span class="sxs-lookup"><span data-stu-id="11fd3-553">AzureRM.ApiManagement</span></span>
* <span data-ttu-id="11fd3-554">增加了对 ApiVersions、ApiReleases 和 ApiRevisions 的支持</span><span class="sxs-lookup"><span data-stu-id="11fd3-554">Added support for ApiVersions, ApiReleases and ApiRevisions</span></span>
* <span data-ttu-id="11fd3-555">增加了对 ServiceFabric 后端的支持</span><span class="sxs-lookup"><span data-stu-id="11fd3-555">Added suppport for ServiceFabric Backend</span></span>
* <span data-ttu-id="11fd3-556">增加了对 Application Insights Logger 的支持</span><span class="sxs-lookup"><span data-stu-id="11fd3-556">Added support for Application Insights Logger</span></span>
* <span data-ttu-id="11fd3-557">增加的支持包括认可“基本”SKU 是 API 管理服务的有效 SKU</span><span class="sxs-lookup"><span data-stu-id="11fd3-557">Added support for recognizing 'Basic' sku as a valid sku of Api Management service</span></span>
* <span data-ttu-id="11fd3-558">增加的支持包括允许将专用 CA 颁发的证书作为根证书或 CA 证书安装</span><span class="sxs-lookup"><span data-stu-id="11fd3-558">Added support for installing Certificates issued by private CA as Root or CA</span></span>
* <span data-ttu-id="11fd3-559">增加的支持包括通过 KeyVault 和多个代理主机名接受自定义 SSL 证书</span><span class="sxs-lookup"><span data-stu-id="11fd3-559">Added support for accepting Custom SSL certificates via KeyVault and Multiple proxy hostnames</span></span>
* <span data-ttu-id="11fd3-560">增加了对 MSI 标识的支持</span><span class="sxs-lookup"><span data-stu-id="11fd3-560">Added support for MSI identity</span></span>
* <span data-ttu-id="11fd3-561">增加的支持包括通过 URL 接受策略 注意：以下 cmdlet 将在未来版本中弃用</span><span class="sxs-lookup"><span data-stu-id="11fd3-561">Added support for accepting Policies via Url NOTE: The following cmdlets will be deprecated in future release</span></span>
   - <span data-ttu-id="11fd3-562">Import-AzureRmApiManagementHostnameCertificate</span><span class="sxs-lookup"><span data-stu-id="11fd3-562">Import-AzureRmApiManagementHostnameCertificate</span></span>
   - <span data-ttu-id="11fd3-563">New-AzureRmApiManagementHostnameConfiguration</span><span class="sxs-lookup"><span data-stu-id="11fd3-563">New-AzureRmApiManagementHostnameConfiguration</span></span>
   - <span data-ttu-id="11fd3-564">Set-AzureRmApiManagementHostnames</span><span class="sxs-lookup"><span data-stu-id="11fd3-564">Set-AzureRmApiManagementHostnames</span></span>
   - <span data-ttu-id="11fd3-565">Update-AzureRmApiManagementDeployment</span><span class="sxs-lookup"><span data-stu-id="11fd3-565">Update-AzureRmApiManagementDeployment</span></span>

#### <a name="azurermbatch"></a><span data-ttu-id="11fd3-566">AzureRM.Batch</span><span class="sxs-lookup"><span data-stu-id="11fd3-566">AzureRM.Batch</span></span>
* <span data-ttu-id="11fd3-567">发布新 cmdlet Get-AzureBatchPoolNodeCounts</span><span class="sxs-lookup"><span data-stu-id="11fd3-567">Release new cmdlet Get-AzureBatchPoolNodeCounts</span></span>
* <span data-ttu-id="11fd3-568">发布新 cmdlet Start-AzureBatchComputeNodeServiceLogUpload</span><span class="sxs-lookup"><span data-stu-id="11fd3-568">Release new cmdlet Start-AzureBatchComputeNodeServiceLogUpload</span></span>

#### <a name="azurermconsumption"></a><span data-ttu-id="11fd3-569">AzureRM.Consumption</span><span class="sxs-lookup"><span data-stu-id="11fd3-569">AzureRM.Consumption</span></span>
* <span data-ttu-id="11fd3-570">在 Cmdlet Get-AzureRmConsumptionUsageDetail 中增加了新参数 Expand、ResourceGroup、InstanceName、InstanceId、Tags、Top</span><span class="sxs-lookup"><span data-stu-id="11fd3-570">Add new parameters Expand, ResourceGroup, InstanceName, InstanceId, Tags, and Top on Cmdlet Get-AzureRmConsumptionUsageDetail</span></span>

#### <a name="azurermdatalakestore"></a><span data-ttu-id="11fd3-571">AzureRM.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="11fd3-571">AzureRM.DataLakeStore</span></span>
* <span data-ttu-id="11fd3-572">修复了 Export-AzureRmDataLakeStoreChildItemProperties 的示例</span><span class="sxs-lookup"><span data-stu-id="11fd3-572">Fix example for Export-AzureRmDataLakeStoreChildItemProperties</span></span>
* <span data-ttu-id="11fd3-573">修复了 Set-AzureRmDataLakeStoreItemAclEntry 中 Recurse 用例的 null 参数异常</span><span class="sxs-lookup"><span data-stu-id="11fd3-573">Fix null parameter exception for Recurse case in Set-AzureRmDataLakeStoreItemAclEntry</span></span> 
* <span data-ttu-id="11fd3-574">修复了 Set-AzureRmDataLakeStoreItemAclEntry、Set-AzureRmDataLakeStoreItemAcl、Remove-AzureRmDataLakeStoreItemAclEntry 的帮助文件</span><span class="sxs-lookup"><span data-stu-id="11fd3-574">Fix the help files for Set-AzureRmDataLakeStoreItemAclEntry, Set-AzureRmDataLakeStoreItemAcl, Remove-AzureRmDataLakeStoreItemAclEntry</span></span> 

#### <a name="azurermnetwork"></a><span data-ttu-id="11fd3-575">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="11fd3-575">AzureRM.Network</span></span>
* <span data-ttu-id="11fd3-576">将网络 SDK 版本从 18.0.0-preview 升至 19.0.0-preview</span><span class="sxs-lookup"><span data-stu-id="11fd3-576">Bump up Network SDK version from 18.0.0-preview to 19.0.0-preview</span></span>
* <span data-ttu-id="11fd3-577">增加了用于创建协议配置的 cmdlet</span><span class="sxs-lookup"><span data-stu-id="11fd3-577">Added cmdlet to create protocol configuration</span></span>
    - <span data-ttu-id="11fd3-578">New-AzureRmNetworkWatcherProtocolConfiguration</span><span class="sxs-lookup"><span data-stu-id="11fd3-578">New-AzureRmNetworkWatcherProtocolConfiguration</span></span>
* <span data-ttu-id="11fd3-579">增加了用于向现有的快速路由线路添加新的线路连接的 cmdlet。</span><span class="sxs-lookup"><span data-stu-id="11fd3-579">Added cmdlet to add a new circuit connection to an existing express route circuit.</span></span>
    - <span data-ttu-id="11fd3-580">Add-AzureRmExpressRouteCircuitConnectionConfig</span><span class="sxs-lookup"><span data-stu-id="11fd3-580">Add-AzureRmExpressRouteCircuitConnectionConfig</span></span>
* <span data-ttu-id="11fd3-581">增加了用于从现有的快速路由线路删除线路连接的 cmdlet。</span><span class="sxs-lookup"><span data-stu-id="11fd3-581">Added cmdlet to remove a circuit connection from an existing express route circuit.</span></span>
    - <span data-ttu-id="11fd3-582">Remove-AzureRmExpressRouteCircuitConnectionConfig</span><span class="sxs-lookup"><span data-stu-id="11fd3-582">Remove-AzureRmExpressRouteCircuitConnectionConfig</span></span>
* <span data-ttu-id="11fd3-583">增加了用于检索线路连接的 cmdlet</span><span class="sxs-lookup"><span data-stu-id="11fd3-583">Added cmdlet to retrieve a circuit connection</span></span>
    - <span data-ttu-id="11fd3-584">Get-AzureRmExpressRouteCircuitConnectionConfig</span><span class="sxs-lookup"><span data-stu-id="11fd3-584">Get-AzureRmExpressRouteCircuitConnectionConfig</span></span>

#### <a name="azurermservicefabric"></a><span data-ttu-id="11fd3-585">AzureRM.ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="11fd3-585">AzureRM.ServiceFabric</span></span>
* <span data-ttu-id="11fd3-586">修复了使用生成的证书进行服务器身份验证的问题（问题 5998）</span><span class="sxs-lookup"><span data-stu-id="11fd3-586">Fixed server authentication usage with generated certificates (Issue #5998)</span></span>

#### <a name="azurermsql"></a><span data-ttu-id="11fd3-587">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="11fd3-587">AzureRM.Sql</span></span>
* <span data-ttu-id="11fd3-588">更新了审核 cmdlet，允许删除 AuditActions 或 AuditActionGroups</span><span class="sxs-lookup"><span data-stu-id="11fd3-588">Updated Auditing cmdlets to allow removing AuditActions or AuditActionGroups</span></span>
* <span data-ttu-id="11fd3-589">修复了设置新的灵活保留策略时使用 Set-AzureRmSqlDatabaseBackupLongTermRetentionPolicy 出现的问题。该问题的具体表现是：在命令失败的同时，出现“不再支持使用 Azure 恢复服务保管库和策略配置长期保留策略。</span><span class="sxs-lookup"><span data-stu-id="11fd3-589">Fixed issue with Set-AzureRmSqlDatabaseBackupLongTermRetentionPolicy when setting a new flexible retention policy where the command would fail with 'Configure long term retention policy with azure recovery service vault and policy is no longer supported.</span></span> <span data-ttu-id="11fd3-590">请使用新的灵活保留策略提交请求”错误消息。</span><span class="sxs-lookup"><span data-stu-id="11fd3-590">Please submit request with the new flexible retention policy'.</span></span>
* <span data-ttu-id="11fd3-591">更新了与 Azure SQL 数据库/ElasticPool 的创建/更新相关的所有 cmdlet，允许使用新的数据库 API，而这些 cmdlet 支持的 SKU 属性则适用于规模和层相关属性。</span><span class="sxs-lookup"><span data-stu-id="11fd3-591">Update all Azure Sql Database/ElasticPool Creation/Update related cmdlets to use the new Database API, which support Sku property for scale and tier-related properties.</span></span>
* <span data-ttu-id="11fd3-592">更新的 cmdlet 包括：</span><span class="sxs-lookup"><span data-stu-id="11fd3-592">The updated cmdlets including:</span></span> 
    - <span data-ttu-id="11fd3-593">New-AzureRmSqlDatabase；Set-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="11fd3-593">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span></span>
    - <span data-ttu-id="11fd3-594">New-AzureRmSqlElasticPool；Set-AzureRmSqlElasticPool</span><span class="sxs-lookup"><span data-stu-id="11fd3-594">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span></span>
    - <span data-ttu-id="11fd3-595">New-AzureRmSqlDatabaseCopy</span><span class="sxs-lookup"><span data-stu-id="11fd3-595">New-AzureRmSqlDatabaseCopy</span></span>
    - <span data-ttu-id="11fd3-596">New-AzureRmSqlDatabaseSecondary</span><span class="sxs-lookup"><span data-stu-id="11fd3-596">New-AzureRmSqlDatabaseSecondary</span></span>
    - <span data-ttu-id="11fd3-597">Restore-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="11fd3-597">Restore-AzureRmSqlDatabase</span></span>

#### <a name="azurermtrafficmanager"></a><span data-ttu-id="11fd3-598">AzureRM.TrafficManager</span><span class="sxs-lookup"><span data-stu-id="11fd3-598">AzureRM.TrafficManager</span></span>
* <span data-ttu-id="11fd3-599">更新了“Get-AzureRmTrafficManagerProfile”的参数，要求在使用 -Name 参数时使用 -ResourceGroupName 参数。</span><span class="sxs-lookup"><span data-stu-id="11fd3-599">Update the parameters for 'Get-AzureRmTrafficManagerProfile' so that -ResourceGroupName parameter is required when using -Name parameter.</span></span>
