...
#### <a name="azurermanalysisservices"></a><span data-ttu-id="97c70-114">AzureRM.AnalysisServices</span><span class="sxs-lookup"><span data-stu-id="97c70-114">AzureRM.AnalysisServices</span></span>
...
#### <a name="azurermcdn"></a><span data-ttu-id="97c70-130">AzureRM.Cdn</span><span class="sxs-lookup"><span data-stu-id="97c70-130">AzureRM.Cdn</span></span>
...
#### <a name="azurermdatafactories"></a><span data-ttu-id="97c70-146">AzureRM.DataFactories</span><span class="sxs-lookup"><span data-stu-id="97c70-146">AzureRM.DataFactories</span></span>
...
#### <a name="azurermeventhub"></a><span data-ttu-id="97c70-163">AzureRM.EventHub</span><span class="sxs-lookup"><span data-stu-id="97c70-163">AzureRM.EventHub</span></span>
...
#### <a name="azurermmedia"></a><span data-ttu-id="97c70-181">AzureRM.Media</span><span class="sxs-lookup"><span data-stu-id="97c70-181">AzureRM.Media</span></span>
...
#### <a name="azurermpowerbiembedded"></a><span data-ttu-id="97c70-198">AzureRM.PowerBIEmbedded</span><span class="sxs-lookup"><span data-stu-id="97c70-198">AzureRM.PowerBIEmbedded</span></span>
...
#### <a name="azurermresources"></a><span data-ttu-id="97c70-216">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="97c70-216">AzureRM.Resources</span></span>
...
#### <a name="azurermstorage"></a><span data-ttu-id="97c70-237">AzureRM.Storage</span><span class="sxs-lookup"><span data-stu-id="97c70-237">AzureRM.Storage</span></span>
...
#### <a name="azurestorage"></a><span data-ttu-id="97c70-255">Azure.存储</span><span class="sxs-lookup"><span data-stu-id="97c70-255">Azure.Storage</span></span>
...
#### <a name="azurermdatafactoryv2"></a><span data-ttu-id="97c70-276">AzureRM.DataFactoryV2</span><span class="sxs-lookup"><span data-stu-id="97c70-276">AzureRM.DataFactoryV2</span></span>
...
#### <a name="azurermresources"></a><span data-ttu-id="97c70-292">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="97c70-292">AzureRM.Resources</span></span>
...
#### <a name="azurermstorage"></a><span data-ttu-id="97c70-307">AzureRM.Storage</span><span class="sxs-lookup"><span data-stu-id="97c70-307">AzureRM.Storage</span></span>
...
#### <a name="azurermcompute"></a><span data-ttu-id="97c70-326">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="97c70-326">AzureRM.Compute</span></span>
...
#### <a name="azurermrelay"></a><span data-ttu-id="97c70-345">AzureRM.Relay</span><span class="sxs-lookup"><span data-stu-id="97c70-345">AzureRM.Relay</span></span>
...
#### <a name="azurermsql"></a><span data-ttu-id="97c70-364">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="97c70-364">AzureRM.Sql</span></span>
...
* <span data-ttu-id="97c70-383">VMSS 的 OS 升级历史记录功能</span><span class="sxs-lookup"><span data-stu-id="97c70-383">OS Upgrade History feature for Vmss</span></span>
    - <span data-ttu-id="97c70-384">已将 OSUpgradeHistory 开关参数添加到 Get-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="97c70-384">OSUpgradeHistory switch parameter is added to Get-AzureRmVmss</span></span>
...
#### <a name="azurermkeyvault"></a><span data-ttu-id="97c70-400">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="97c70-400">AzureRM.KeyVault</span></span>
...
#### <a name="azurermresources"></a><span data-ttu-id="97c70-417">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="97c70-417">AzureRM.Resources</span></span>
...
## <a name="630---june-2018"></a><span data-ttu-id="97c70-436">6.3.0 - 2018 年 6 月</span><span class="sxs-lookup"><span data-stu-id="97c70-436">6.3.0 - June 2018</span></span>
...
* <span data-ttu-id="97c70-448">修复了以下 cmdlet，因此可以正确地显示“操作 ID”和“操作状态”：</span><span class="sxs-lookup"><span data-stu-id="97c70-448">Fixed following cmdlets to show 'operation ID' and 'operation status' correctly:</span></span>
    ...
    - <span data-ttu-id="97c70-461">ConvertTo-AzureRmVMManagedDisk</span><span class="sxs-lookup"><span data-stu-id="97c70-461">ConvertTo-AzureRmVMManagedDisk</span></span>
...
#### <a name="azurermsql"></a><span data-ttu-id="97c70-479">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="97c70-479">AzureRM.Sql</span></span>
...
* <span data-ttu-id="97c70-485">更新了“New-AzureRmWebAppSlot”，允许使用 AppServicePlan 作为可选参数</span><span class="sxs-lookup"><span data-stu-id="97c70-485">'New-AzureRmWebAppSlot' is updated to honor AppServicePlan as an optional parameter</span></span>

## <a name="621---june-2018"></a><span data-ttu-id="97c70-486">6.2.1 - 2018 年 6 月</span><span class="sxs-lookup"><span data-stu-id="97c70-486">6.2.1 - June 2018</span></span>
### <a name="azurermoperationalinsights"></a><span data-ttu-id="97c70-487">AzureRM.OperationalInsights</span><span class="sxs-lookup"><span data-stu-id="97c70-487">AzureRM.OperationalInsights</span></span>
* <span data-ttu-id="97c70-488">更新了 PSWorkspace 模型，允许 Network 使用 type 作为参数</span><span class="sxs-lookup"><span data-stu-id="97c70-488">Updated PSWorkspace model to allow Network to use type as a parameter</span></span>

## <a name="620---june-2018"></a><span data-ttu-id="97c70-489">6.2.0 - 2018 年 6 月</span><span class="sxs-lookup"><span data-stu-id="97c70-489">6.2.0 - June 2018</span></span>
#### <a name="azurermprofile"></a><span data-ttu-id="97c70-490">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="97c70-490">AzureRM.Profile</span></span>
* <span data-ttu-id="97c70-491">修复了 Newtonsoft.Json 的版本 10.0.3 在模块导入时无法加载的问题</span><span class="sxs-lookup"><span data-stu-id="97c70-491">Fix issue where version 10.0.3 of Newtonsoft.Json wasn't being loaded on module import</span></span>

#### <a name="azurermcompute"></a><span data-ttu-id="97c70-492">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="97c70-492">AzureRM.Compute</span></span>
* <span data-ttu-id="97c70-493">VMSS VM 更新功能</span><span class="sxs-lookup"><span data-stu-id="97c70-493">VMSS VM Update feature</span></span>
    - <span data-ttu-id="97c70-494">增加了“Update-AzureRmVmssVM”和“New-AzureRmVMDataDisk”cmdlet</span><span class="sxs-lookup"><span data-stu-id="97c70-494">Added 'Update-AzureRmVmssVM' and 'New-AzureRmVMDataDisk' cmdlets</span></span>
    - <span data-ttu-id="97c70-495">为“Add-AzureRmVMDataDisk”cmdlet 增加了 VirtualMachineScaleSetVM 参数，支持向 Vmss VM 添加数据磁盘。</span><span class="sxs-lookup"><span data-stu-id="97c70-495">Add VirtualMachineScaleSetVM parameter to 'Add-AzureRmVMDataDisk' cmdlet to support adding a data disk to Vmss VM.</span></span>

#### <a name="azurermdatafactoryv2"></a><span data-ttu-id="97c70-496">AzureRM.DataFactoryV2</span><span class="sxs-lookup"><span data-stu-id="97c70-496">AzureRM.DataFactoryV2</span></span>
* <span data-ttu-id="97c70-497">将 ADF.Net SDK 版本更新到了 0.8.0-preview，其中包含以下更改：</span><span class="sxs-lookup"><span data-stu-id="97c70-497">Updated the ADF .Net SDK version to 0.8.0-preview containing following changes:</span></span>
    - <span data-ttu-id="97c70-498">增加了“配置工厂存储库”操作</span><span class="sxs-lookup"><span data-stu-id="97c70-498">Added Configure factory repository operation</span></span>
    - <span data-ttu-id="97c70-499">更新了 QuickBooks LinkedService，可以公开 consumerKey 和 consumerSecret 属性</span><span class="sxs-lookup"><span data-stu-id="97c70-499">Updated QuickBooks LinkedService to expose consumerKey and consumerSecret properties</span></span>
    - <span data-ttu-id="97c70-500">已将多个模型类型从 SecretBase 更新为 Object</span><span class="sxs-lookup"><span data-stu-id="97c70-500">Updated Several model types from SecretBase to Object</span></span>
    - <span data-ttu-id="97c70-501">增加了 Blob 事件触发器</span><span class="sxs-lookup"><span data-stu-id="97c70-501">Added Blob Events trigger</span></span>

### <a name="azurermkeyvault"></a><span data-ttu-id="97c70-502">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="97c70-502">AzureRM.KeyVault</span></span>
* <span data-ttu-id="97c70-503">使用示例输出更新了文档</span><span class="sxs-lookup"><span data-stu-id="97c70-503">Update documentation with example output</span></span>

### <a name="azurermnetwork"></a><span data-ttu-id="97c70-504">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="97c70-504">AzureRM.Network</span></span>
* <span data-ttu-id="97c70-505">在网络观察程序 cmdlet 上启用了流量分析参数</span><span class="sxs-lookup"><span data-stu-id="97c70-505">Enable Traffic Analytics parameters on Network Watcher cmdlets</span></span>

#### <a name="azurermresources"></a><span data-ttu-id="97c70-506">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="97c70-506">AzureRM.Resources</span></span>
* <span data-ttu-id="97c70-507">修复了从“Get-AzureRmResource”返回的“PSResource”对象的“Properties”属性问题</span><span class="sxs-lookup"><span data-stu-id="97c70-507">Fix issue with 'Properties' property of 'PSResource' object(s) returned from 'Get-AzureRmResource'</span></span>

#### <a name="azurermscheduler"></a><span data-ttu-id="97c70-508">AzureRM.Scheduler</span><span class="sxs-lookup"><span data-stu-id="97c70-508">AzureRM.Scheduler</span></span>
* <span data-ttu-id="97c70-509">修复了更新 ServiceBusQueueJob 无法设置新 Auth 值的问题</span><span class="sxs-lookup"><span data-stu-id="97c70-509">Fix issue with update ServiceBusQueueJob not setting new Auth values</span></span>

### <a name="azurermsql"></a><span data-ttu-id="97c70-510">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="97c70-510">AzureRM.Sql</span></span>
* <span data-ttu-id="97c70-511">使用可选的 LicenseType 参数更新了以下 cmdlet</span><span class="sxs-lookup"><span data-stu-id="97c70-511">Updated the following cmdlets with optional LicenseType parameter</span></span>
    - <span data-ttu-id="97c70-512">New-AzureRmSqlDatabase；Set-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="97c70-512">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span></span>
    - <span data-ttu-id="97c70-513">New-AzureRmSqlElasticPool；Set-AzureRmSqlElasticPool</span><span class="sxs-lookup"><span data-stu-id="97c70-513">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span></span>
    - <span data-ttu-id="97c70-514">New-AzureRmSqlDatabaseCopy</span><span class="sxs-lookup"><span data-stu-id="97c70-514">New-AzureRmSqlDatabaseCopy</span></span>
    - <span data-ttu-id="97c70-515">New-AzureRmSqlDatabaseSecondary</span><span class="sxs-lookup"><span data-stu-id="97c70-515">New-AzureRmSqlDatabaseSecondary</span></span>
    - <span data-ttu-id="97c70-516">Restore-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="97c70-516">Restore-AzureRmSqlDatabase</span></span>

#### <a name="azurermwebsites"></a><span data-ttu-id="97c70-517">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="97c70-517">AzureRM.Websites</span></span>
* <span data-ttu-id="97c70-518">更新了“New-AzureRMWebApp”，可以使用策略库中的常用算法。</span><span class="sxs-lookup"><span data-stu-id="97c70-518">'New-AzureRMWebApp' is updated to use common algorithms from the Strategy library.</span></span>

## <a name="610---may-2018"></a><span data-ttu-id="97c70-519">6.1.0 - 2018 年 5 月</span><span class="sxs-lookup"><span data-stu-id="97c70-519">6.1.0 - May 2018</span></span>
#### <a name="azurermprofile"></a><span data-ttu-id="97c70-520">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="97c70-520">AzureRM.Profile</span></span>
* <span data-ttu-id="97c70-521">修复了运行“Clear-AzureRmContext”时会保留空上下文的问题，该上下文使用旧的默认上下文的名称，导致用户无法使用旧名称创建新的上下文</span><span class="sxs-lookup"><span data-stu-id="97c70-521">Fix issue where running 'Clear-AzureRmContext' would keep an empty context with the name of the previous default context, which prevented the user from creating a new context with the old name</span></span>

#### <a name="azurermanalysisservices"></a><span data-ttu-id="97c70-522">AzureRM.AnalysisServices</span><span class="sxs-lookup"><span data-stu-id="97c70-522">AzureRM.AnalysisServices</span></span>
* <span data-ttu-id="97c70-523">允许在 AS 上执行网关的关联/取消关联操作。</span><span class="sxs-lookup"><span data-stu-id="97c70-523">Enable Gateway assocaite/disassociate operations on AS.</span></span>

#### <a name="azurermapimanagement"></a><span data-ttu-id="97c70-524">AzureRM.ApiManagement</span><span class="sxs-lookup"><span data-stu-id="97c70-524">AzureRM.ApiManagement</span></span>
* <span data-ttu-id="97c70-525">增加了对 ApiVersions、ApiReleases 和 ApiRevisions 的支持</span><span class="sxs-lookup"><span data-stu-id="97c70-525">Added support for ApiVersions, ApiReleases and ApiRevisions</span></span>
* <span data-ttu-id="97c70-526">增加了对 ServiceFabric 后端的支持</span><span class="sxs-lookup"><span data-stu-id="97c70-526">Added suppport for ServiceFabric Backend</span></span>
* <span data-ttu-id="97c70-527">增加了对 Application Insights Logger 的支持</span><span class="sxs-lookup"><span data-stu-id="97c70-527">Added support for Application Insights Logger</span></span>
* <span data-ttu-id="97c70-528">增加的支持包括认可“基本”SKU 是 API 管理服务的有效 SKU</span><span class="sxs-lookup"><span data-stu-id="97c70-528">Added support for recognizing 'Basic' sku as a valid sku of Api Management service</span></span>
* <span data-ttu-id="97c70-529">增加的支持包括允许将专用 CA 颁发的证书作为根证书或 CA 证书安装</span><span class="sxs-lookup"><span data-stu-id="97c70-529">Added support for installing Certificates issued by private CA as Root or CA</span></span>
* <span data-ttu-id="97c70-530">增加的支持包括通过 KeyVault 和多个代理主机名接受自定义 SSL 证书</span><span class="sxs-lookup"><span data-stu-id="97c70-530">Added support for accepting Custom SSL certificates via KeyVault and Multiple proxy hostnames</span></span>
* <span data-ttu-id="97c70-531">增加了对 MSI 标识的支持</span><span class="sxs-lookup"><span data-stu-id="97c70-531">Added support for MSI identity</span></span>
* <span data-ttu-id="97c70-532">增加的支持包括通过 URL 接受策略 注意：以下 cmdlet 将在未来版本中弃用</span><span class="sxs-lookup"><span data-stu-id="97c70-532">Added support for accepting Policies via Url NOTE: The following cmdlets will be deprecated in future release</span></span>
   - <span data-ttu-id="97c70-533">Import-AzureRmApiManagementHostnameCertificate</span><span class="sxs-lookup"><span data-stu-id="97c70-533">Import-AzureRmApiManagementHostnameCertificate</span></span>
   - <span data-ttu-id="97c70-534">New-AzureRmApiManagementHostnameConfiguration</span><span class="sxs-lookup"><span data-stu-id="97c70-534">New-AzureRmApiManagementHostnameConfiguration</span></span>
   - <span data-ttu-id="97c70-535">Set-AzureRmApiManagementHostnames</span><span class="sxs-lookup"><span data-stu-id="97c70-535">Set-AzureRmApiManagementHostnames</span></span>
   - <span data-ttu-id="97c70-536">Update-AzureRmApiManagementDeployment</span><span class="sxs-lookup"><span data-stu-id="97c70-536">Update-AzureRmApiManagementDeployment</span></span>

#### <a name="azurermbatch"></a><span data-ttu-id="97c70-537">AzureRM.Batch</span><span class="sxs-lookup"><span data-stu-id="97c70-537">AzureRM.Batch</span></span>
* <span data-ttu-id="97c70-538">发布新 cmdlet Get-AzureBatchPoolNodeCounts</span><span class="sxs-lookup"><span data-stu-id="97c70-538">Release new cmdlet Get-AzureBatchPoolNodeCounts</span></span>
* <span data-ttu-id="97c70-539">发布新 cmdlet Start-AzureBatchComputeNodeServiceLogUpload</span><span class="sxs-lookup"><span data-stu-id="97c70-539">Release new cmdlet Start-AzureBatchComputeNodeServiceLogUpload</span></span>

#### <a name="azurermconsumption"></a><span data-ttu-id="97c70-540">AzureRM.Consumption</span><span class="sxs-lookup"><span data-stu-id="97c70-540">AzureRM.Consumption</span></span>
* <span data-ttu-id="97c70-541">在 Cmdlet Get-AzureRmConsumptionUsageDetail 中增加了新参数 Expand、ResourceGroup、InstanceName、InstanceId、Tags、Top</span><span class="sxs-lookup"><span data-stu-id="97c70-541">Add new parameters Expand, ResourceGroup, InstanceName, InstanceId, Tags, and Top on Cmdlet Get-AzureRmConsumptionUsageDetail</span></span>

#### <a name="azurermdatalakestore"></a><span data-ttu-id="97c70-542">AzureRM.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="97c70-542">AzureRM.DataLakeStore</span></span>
* <span data-ttu-id="97c70-543">修复了 Export-AzureRmDataLakeStoreChildItemProperties 的示例</span><span class="sxs-lookup"><span data-stu-id="97c70-543">Fix example for Export-AzureRmDataLakeStoreChildItemProperties</span></span>
* <span data-ttu-id="97c70-544">修复了 Set-AzureRmDataLakeStoreItemAclEntry 中 Recurse 用例的 null 参数异常</span><span class="sxs-lookup"><span data-stu-id="97c70-544">Fix null parameter exception for Recurse case in Set-AzureRmDataLakeStoreItemAclEntry</span></span> 
* <span data-ttu-id="97c70-545">修复了 Set-AzureRmDataLakeStoreItemAclEntry、Set-AzureRmDataLakeStoreItemAcl、Remove-AzureRmDataLakeStoreItemAclEntry 的帮助文件</span><span class="sxs-lookup"><span data-stu-id="97c70-545">Fix the help files for Set-AzureRmDataLakeStoreItemAclEntry, Set-AzureRmDataLakeStoreItemAcl, Remove-AzureRmDataLakeStoreItemAclEntry</span></span> 

#### <a name="azurermnetwork"></a><span data-ttu-id="97c70-546">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="97c70-546">AzureRM.Network</span></span>
* <span data-ttu-id="97c70-547">将网络 SDK 版本从 18.0.0-preview 升至 19.0.0-preview</span><span class="sxs-lookup"><span data-stu-id="97c70-547">Bump up Network SDK version from 18.0.0-preview to 19.0.0-preview</span></span>
* <span data-ttu-id="97c70-548">增加了用于创建协议配置的 cmdlet</span><span class="sxs-lookup"><span data-stu-id="97c70-548">Added cmdlet to create protocol configuration</span></span>
    - <span data-ttu-id="97c70-549">New-AzureRmNetworkWatcherProtocolConfiguration</span><span class="sxs-lookup"><span data-stu-id="97c70-549">New-AzureRmNetworkWatcherProtocolConfiguration</span></span>
* <span data-ttu-id="97c70-550">增加了用于向现有的快速路由线路添加新的线路连接的 cmdlet。</span><span class="sxs-lookup"><span data-stu-id="97c70-550">Added cmdlet to add a new circuit connection to an existing express route circuit.</span></span>
    - <span data-ttu-id="97c70-551">Add-AzureRmExpressRouteCircuitConnectionConfig</span><span class="sxs-lookup"><span data-stu-id="97c70-551">Add-AzureRmExpressRouteCircuitConnectionConfig</span></span>
* <span data-ttu-id="97c70-552">增加了用于从现有的快速路由线路删除线路连接的 cmdlet。</span><span class="sxs-lookup"><span data-stu-id="97c70-552">Added cmdlet to remove a circuit connection from an existing express route circuit.</span></span>
    - <span data-ttu-id="97c70-553">Remove-AzureRmExpressRouteCircuitConnectionConfig</span><span class="sxs-lookup"><span data-stu-id="97c70-553">Remove-AzureRmExpressRouteCircuitConnectionConfig</span></span>
* <span data-ttu-id="97c70-554">增加了用于检索线路连接的 cmdlet</span><span class="sxs-lookup"><span data-stu-id="97c70-554">Added cmdlet to retrieve a circuit connection</span></span>
    - <span data-ttu-id="97c70-555">Get-AzureRmExpressRouteCircuitConnectionConfig</span><span class="sxs-lookup"><span data-stu-id="97c70-555">Get-AzureRmExpressRouteCircuitConnectionConfig</span></span>

#### <a name="azurermservicefabric"></a><span data-ttu-id="97c70-556">AzureRM.ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="97c70-556">AzureRM.ServiceFabric</span></span>
* <span data-ttu-id="97c70-557">修复了使用生成的证书进行服务器身份验证的问题（问题 5998）</span><span class="sxs-lookup"><span data-stu-id="97c70-557">Fixed server authentication usage with generated certificates (Issue #5998)</span></span>

#### <a name="azurermsql"></a><span data-ttu-id="97c70-558">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="97c70-558">AzureRM.Sql</span></span>
* <span data-ttu-id="97c70-559">更新了审核 cmdlet，允许删除 AuditActions 或 AuditActionGroups</span><span class="sxs-lookup"><span data-stu-id="97c70-559">Updated Auditing cmdlets to allow removing AuditActions or AuditActionGroups</span></span>
* <span data-ttu-id="97c70-560">修复了设置新的灵活保留策略时使用 Set-AzureRmSqlDatabaseBackupLongTermRetentionPolicy 出现的问题。该问题的具体表现是：在命令失败的同时，出现“不再支持使用 Azure 恢复服务保管库和策略配置长期保留策略。</span><span class="sxs-lookup"><span data-stu-id="97c70-560">Fixed issue with Set-AzureRmSqlDatabaseBackupLongTermRetentionPolicy when setting a new flexible retention policy where the command would fail with 'Configure long term retention policy with azure recovery service vault and policy is no longer supported.</span></span> <span data-ttu-id="97c70-561">请使用新的灵活保留策略提交请求”错误消息。</span><span class="sxs-lookup"><span data-stu-id="97c70-561">Please submit request with the new flexible retention policy'.</span></span>
* <span data-ttu-id="97c70-562">更新了与 Azure SQL 数据库/ElasticPool 的创建/更新相关的所有 cmdlet，允许使用新的数据库 API，而这些 cmdlet 支持的 SKU 属性则适用于规模和层相关属性。</span><span class="sxs-lookup"><span data-stu-id="97c70-562">Update all Azure Sql Database/ElasticPool Creation/Update related cmdlets to use the new Database API, which support Sku property for scale and tier-related properties.</span></span>
* <span data-ttu-id="97c70-563">更新的 cmdlet 包括：</span><span class="sxs-lookup"><span data-stu-id="97c70-563">The updated cmdlets including:</span></span> 
    - <span data-ttu-id="97c70-564">New-AzureRmSqlDatabase；Set-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="97c70-564">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span></span>
    - <span data-ttu-id="97c70-565">New-AzureRmSqlElasticPool；Set-AzureRmSqlElasticPool</span><span class="sxs-lookup"><span data-stu-id="97c70-565">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span></span>
    - <span data-ttu-id="97c70-566">New-AzureRmSqlDatabaseCopy</span><span class="sxs-lookup"><span data-stu-id="97c70-566">New-AzureRmSqlDatabaseCopy</span></span>
    - <span data-ttu-id="97c70-567">New-AzureRmSqlDatabaseSecondary</span><span class="sxs-lookup"><span data-stu-id="97c70-567">New-AzureRmSqlDatabaseSecondary</span></span>
    - <span data-ttu-id="97c70-568">Restore-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="97c70-568">Restore-AzureRmSqlDatabase</span></span>

#### <a name="azurermtrafficmanager"></a><span data-ttu-id="97c70-569">AzureRM.TrafficManager</span><span class="sxs-lookup"><span data-stu-id="97c70-569">AzureRM.TrafficManager</span></span>
* <span data-ttu-id="97c70-570">更新了“Get-AzureRmTrafficManagerProfile”的参数，要求在使用 -Name 参数时使用 -ResourceGroupName 参数。</span><span class="sxs-lookup"><span data-stu-id="97c70-570">Update the parameters for 'Get-AzureRmTrafficManagerProfile' so that -ResourceGroupName parameter is required when using -Name parameter.</span></span>
